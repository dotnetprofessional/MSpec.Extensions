...
namespace xpf.IO
{
    ...
    {
        internal static Stream GetResourceStream(string resourceName, Type caller)
        {
        ...
        /// <param name="resourceName">The name of the resource file to return. The filename is matched using EndsWith allowing for partial filenames to be used.</param>
        /// <returns></returns>
        internal static byte[] GetResource(Type caller, string resourceName)
        {
        ...
        internal static T RetrieveResourceObject<T>(object caller, string embeddedFile, params Type[] extraTypes)
            where T:class 
        {
